...
Next, move the compiled `janus/libjanus_ustreamer.so` shared library file to the plugin directory of your Janus installation. By default, the base path of Janus is `/opt/janus`.
